...
Group:          kernel
Source0:        https://cdn.kernel.org/pub/linux/kernel/v4.x/linux-4.19.284.tar.xz
Source1:        config
Source2:        cmdline

%define ktarget  lts2018
...
Summary:        The Linux kernel
Group:          kernel
Requires:       linux-lts2018 = %{version}-%{release}
Requires:       linux-lts2018-extra = %{version}-%{release}
Requires:       linux-lts2018-license = %{version}-%{release}
...
mkdir -p %{buildroot}/usr/share/package-licenses/linux-lts2018
cp COPYING %{buildroot}/usr/share/package-licenses/linux-lts2018/COPYING
cp -a LICENSES/* %{buildroot}/usr/share/package-licenses/linux-lts2018
...
/usr/share/package-licenses/linux-lts2018
